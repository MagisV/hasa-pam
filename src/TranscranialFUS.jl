...
export EmissionSource2D, PointSource2D, BubbleCluster2D, GaussianPulseCluster2D, PAMConfig, PAMWindowConfig, SourceVariabilityConfig, fit_pam_config, pam_Nx, pam_Ny, pam_Nt, pam_grid, receiver_row, receiver_col_range, depth_coordinates
...
export EmissionSource3D, PointSource3D, BubbleCluster3D, make_squiggle_bubble_sources_3d
